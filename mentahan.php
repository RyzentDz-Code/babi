...
$header[] = 'pin:'.$pin.'';
					...
					echo "[+-] Process Transfer Rp. 1 +AFw-n";
...
if ($jstf && true === $jstf->success) {
    echo "[+-] Sukses Transfer Gopay Rp. 1 +AFw-n";
    } else {
        echo "[+-] Gagal Transfer Gopay  +AFw-n";
        }
    {
...
$detail = curl('https://api.gojekapi.com/wallet/profile/detailed', null, $header);
         $saldoo = json_decode($detail[0]);
                $saldo = $saldoo->data->balance;
                    echo "[+-] Sisa Saldo Gopay = $saldo +AFw-n";
                    echo "+AFw-n";
                    echo "[!] Gunakan dengan bijak mek! +AFw-n";
                    echo "[!] ANJG KIRIK ASU JEMBUT MMK WEDUS BABI! +AFw-n";
                    echo "[!] ANJG KIRIK ASU JEMBUT MMK WEDUS BABI! +AFw-n";
                    echo "[!] ANJG KIRIK ASU JEMBUT MMK WEDUS BABI! +AFw-n";
                    echo "[!] ANJG KIRIK ASU JEMBUT MMK WEDUS BABI! +AFw-n";
                    echo "[!] ANJG KIRIK ASU JEMBUT MMK WEDUS BABI! +AFw-n";
